...
class RealmWeatherViewController: UIViewController {
    ...
    var weatherService = AlamofireWeatherService()
    ...
    func configureTableView(){
        ...
        tableView.register(RealmWeatherForcastTableViewCell.self, forCellReuseIdentifier: "Cell")
...
extension RealmWeatherViewController: UITableViewDelegate, UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return forcastWeatherDataArray.count
    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath as IndexPath) as! RealmWeatherForcastTableViewCell
